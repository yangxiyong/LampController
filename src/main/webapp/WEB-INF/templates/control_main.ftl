        ...
        <tr>
            ...
            <td width="7%">
                ...
                <div class="input-group input-group-sm">
                    <input type="text" id="query_input" name="cName" class="form-control" placeholder="请输入控制器名称来查询">
    ...
    <div class="box-body table-responsive">
        <div role="grid" class="dataTables_wrapper form-inline" id="example1_wrapper">
            ...
            <tr role="row"><th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 174px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">序号</th>
                <th class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 256px;" aria-label="Browser: activate to sort column ascending">控制器名称</th>
                <th class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 146px;" aria-label="Engine version: activate to sort column ascending">IP</th>
                <th class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 146px;" aria-label="Engine version: activate to sort column ascending">IP-Port</th>
            ...
            <tr><th rowspan="1" colspan="1">序号</th>
                ...
                <th rowspan="1" colspan="1">控制器IP</th>
                <th rowspan="1" colspan="1">控制器IP端口</th>
                <th rowspan="1" colspan="1">创建时间</th>
                <th rowspan="1" colspan="1">创建者</th>
                <th rowspan="1" colspan="1">操作</th></tr>
            </tfoot>
            <tbody role="alert" aria-live="polite" aria-relevant="all">
            <#list page.list as control>
            <tr id="${control_index+1}+newTr">
                <td class="sorting_1">${control_index+1}</td>
                <td>${control.controlName}</td>
                <td>${control.controlIP}</td>
                <td>${control.controlPort}</td>
                <td>${control.createDate?string("yyy-MM-dd")}</td>
                <td>${control.createBy}</td>
                <td>
                    <button onClick="edit(${control.controlID})" data-toggle="tooltip" class="btn btn-warning btn-sm dropdown-toggle"><i class="fa fa-bars"></i></button>
                    <button onClick="del(${control.controlID})"  data-toggle="tooltip" data-widget="remove" class="btn btn-danger btn-sm" data-original-title="Remove"><i class="fa fa-times"></i></button>
                </td>
            </tr>
            </#list>
          </tbody>
